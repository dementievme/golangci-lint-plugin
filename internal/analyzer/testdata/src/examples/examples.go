...
func examples() {
	...
	slog.Info("server started @admin") // want `log message should not contain special character: found: .@.`
	...
	slog.Info("server started!")    // OK – punctuation is allowed
	slog.Info("status: ok")        // OK – colon is allowed
}
